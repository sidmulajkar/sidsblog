...
3. Whoogle-search(Self Host): https://github.com/benbusby/whoogle-search
4. Brave Search: https://search.brave.com/
5. DuckDuckGo Search: https://duckduckgo.com/
6. Quad9 Open Dns Resolver: https://www.quad9.net/
7. NextDNS: https://nextdns.io/
8. Proton Mail: https://proton.me/mail
9. Tor Browser: https://www.torproject.org/
10. I2P Network: https://geti2p.net/en/
11. NewPipe(Alternate youtube frontend for android): https://github.com/TeamNewPipe/NewPipe
12. Grayjay App(FUTO): https://github.com/futo-org/grayjay-android
13. Mullvad Vpn: https://mullvad.net/
14. Tuta Mail: https://tuta.com/
15. Adguard Home: https://github.com/AdguardTeam/AdGuardHome
```
